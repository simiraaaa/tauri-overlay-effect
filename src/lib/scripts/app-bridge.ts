...
const noopBridge: AppBridge = {
  ...
  onChangeChapterSettingVisible: () => noopUnlisten,
  ...
  getChapterSettingVisible: async () => false,
  setChapterSettingVisible: async () => {},
...
const createTauriBridge = async (): Promise<AppBridge> => {
  ...
  const bridge: AppBridge = {
    ...
    onChangeChapterSettingVisible: (callback) => listenPayload<boolean>('change-chapter-setting-visible', callback),
    ...
    getChapterSettingVisible: () => invoke('get_chapter_setting_visible'),
    setChapterSettingVisible: (visible = false) => invoke('set_chapter_setting_visible', { visible }),
